...
# Copy-pasta from enable resource for dev work to upgrade runit cookbook
# If this is to be used at any point going forward, the logic within should
# be converted into helper methods called by the enable and create actions.
action :create do
  package = new_resource.package
  component = new_resource.name
  log_directory = new_resource.log_directory || node[package][component]['log_directory']
